...
| <img height="150px" width="180px" src="_media/logos/obs.png"> | OBS é um programa de gravação de tela open source que ajuda a gravar a tela, uma das maiores vantagens se comparado com a própria gravação das videochamadas é a de ficar armazenado localmente ao invés de gravar e em seguida ter que baixar. |
