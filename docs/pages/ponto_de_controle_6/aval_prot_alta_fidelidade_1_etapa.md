...
## 3. Metodologia
Os princípios que serão inspecionados durante esta avaliação estática estão dispostos e detalhados no [planejamento da primeira etapa](/pages/ponto_de_controle_6/plan_aval_prototipo_alta_fidelidade.md) de avaliação do protótipo de alta fidelidade. O caráter binário dos pontos avaliados permite a criação de um checklist em que cada uma da páginas do protótipo será verificada quanto à sua conformidade com o critério em questão. Caso o critério seja atendido, será assinalado ✅; caso contrário, será assinalado ❌. 

## 4. Avaliação
### 4.1 Nível A

| Tela| Conteúdo não textual |Características sensoriais | Utilização de cores | Três flashes | Página com título | Ordem do foco |Finalidade do link |Cancelamento de acionamento |Identificação do erro | Rótulos e instruções | Autenticação acessível | Entrada redundante | 
:----:|:--:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|:-:|
 **1**  | ✅ | ✅ | ✅ | ? | ? | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ |  |
 **2**  | ✅ | ✅ | ✅ |   |   | ✅ | ✅ | ✅ |   |  |  |  |
 **3**  | ✅ | ✅ | ✅ |   |   | ✅ | ✅ | ✅ |   |  |  |  |
...
#### 4.2.1 Parecer sobre o nível AA
...
| Tela | Contraste (melhorado) | Teclado (sem exceção) | Sem limite de tempo | Nova autenticação | Limites de tempo | Cabeçalhos da seção | Palavras incomuns | Abreviações | Pronúncia | Ajuda | Prevenção de erro |
|:----:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:----:|:-----:|
| **1** |     |  |  |  |  |  |  |  |  |  |  |
| **2** |     |  |  |  |  |  |  |  |  |  |  |
| **3** |     |  |  |  |  |  |  |  |  |  |  |
...
## 5. Conclusão
Os critérios do nível A mostram que alguams telas 
