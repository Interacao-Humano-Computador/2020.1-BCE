...
## 4. Entrevistas
Ao todo foram realizadas 5 entrevistas com estudantes de graduação da Universidade de Brasília do campus de engenharia da Faculdade Gama - FGA.
...
<p align="center">
    <iframe width="560" 
        height="315" 
        src="https://www.youtube.com/embed/upYyRyax80Q" 
        frameborder="0" 
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
        allowfullscreen>
    </iframe>
...
A respeito do segundo storyboard, Kaique concorda que a responsividade no site ajudaria muito na hora de consultar o site pois, no dia a dia da faculdade, quanto mais rápido o acesso à informação, melhor, e o celular é um grande aliado neste momento. Sobre o terceiro storyboard, retratando a situação em que o usuário não consegue reservar um livro pela ausência de exemplares no momento da tentativa, Kaique diz já ter passado exatamente pela situação ilustrada e não ter conseguido o livro desejado.

Em relação ao quarto storyboard e o quanto o agendamento de empréstimo pode beneficiar o estudante, o participante confirma que a funcionalidade é importante por evitar surpresas no momento em que mais se precisa de um livro.

### 4.4 Entrevista 4
<p align="center">
    <iframe width="560"
        height="315" 
        src="https://www.youtube.com/embed/jRtybMPMUA0" 
        frameborder="0" 
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
        allowfullscreen>
    </iframe>
...
Quando perguntada sobre o primeiro storyboard, que retrata a ausência de responsividade do site e os impactos disso na utilização em dispositivos móveis, Amanda confirma que a situação relatada condiz com a realidade e que teve dificuldade em acessar o site da BCE pelo celular nas vezes em que tentou.

Amanda ainda complementa dizendo que o fato de não conseguir acessar o site pelo celular é um impecilho ao tentar utilizar o site dentro da FGA, pois os computadores do campus são poucos e, às vezes, estão todos ocupados, portanto, limitam o acesso ao site da BCE.     

A respeito do segundo storyboard e as vantagens de um site responsivo, a participante diz que com certeza é uma função importante e cita o exemplo de outro site da intituição, SIGAA, como um site que também não é responsivo, afirmando que a função ajudaria bastante os usuários.

O terceiro storyboard, retratando a situação em que o usuário não consegue reservar um livro pela ausência de exemplares no momento da tentativa, Amanda diz que a situação ocorre muitas vezes e que há até um certo desconforto quando o livro físico se encontra na biblioteca mas não é possível fazer o empréstimo por não ter agendando anteriormente.

Desta forma, a participante concorda que a reserva de livros pode ser de grande ajuda caso os estudantes saibam se planejar para utilizar a funcionalidade. Amanda finaliza dizendo que a responsividade no site já seria um grande diferencial e que a divulgação acerca dos serviços que o site da BCE oferece também ajudaria, já que muitos alunos podem não ter conhecimento ou não estar preparados.
